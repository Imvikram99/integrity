        ...
        body:StreamBuilder(
            ...
            builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
              if (!snapshot.hasData) {
                ...
                String uname = snapshot.data?.docs.first['userName'] ==
                    'undefined' ? '' : snapshot.data?.docs.first['userName'];
                String uage = snapshot.data?.docs.first['userAge'] ==
                    'undefined' ? '' : snapshot.data?.docs.first['userAge'];
                String ug = snapshot.data?.docs.first['userGender'] ==
                    'undefined' ? '' : snapshot.data?.docs.first['userGender'];
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Padding(padding: EdgeInsets.only(bottom: MediaQuery.of(context).viewInsets.bottom),
                            child:TextButton(
                                onPressed: (){
                                  Get.to(()=>ReviewerEditProfile(),arguments: [snapshot.data!.docs.first.id,uname,uage,ug ]);
                                },
