...
class _EditServiceState extends State<EditService> {
  ...
  update(ServiceModel model,String id)
  {
    ...
    else
    {
      ...
      controller.updateService(model,id);
      saving=false;
      Get.back();
    }
  }
  ...
  void initState() {
    ...
    _getCurrentPosition();
    model=Get.arguments;
    serviceNameController.text=model.name;
    dropdownValue=model.categoryName;
    servicePriceController.text=model.price;
    serviceDescriptionController.text=model.description;
    startTimeController.text=model.availabilityStartTime;
    endTimeController.text=model.availabilityEndTime;
    startDayController.text=model.availabilityStartDate;
    endDayController.text=model.availabilityEndDate;
    pinCodeController.text=model.pinCode;
    watsAppController.text=model.watsApp;
    emailController.text=model.email;
    upiController.text=model.upiLink;
    telegramController.text=model.telegram;
    zoomLinkController.text=model.zoom;
    webLinkController.text=model.webAddress;
    if(model.customFileds!.length>0 && model.customFileds![0].value!=null){
      cf1Controller.text=model.customFileds![0].value!;
    }
    if(model.customFileds!.length>0 && model.customFileds![1].value!=null){
      cf2Controller.text=model.customFileds![1].value!;
    }
    if(model.customFileds!.length>0 && model.customFileds![2].value!=null){
      cf2Controller.text=model.customFileds![2].value!;
    }
                                  ...
                                  child:Container(
                                    ...
                                    child:Row(
                                      ...
                                      children: [
                                        ...
                                        IconButton(icon: Icon(Icons.access_time,color: Constants.appButtonColor,),
                                          onPressed: () async{
                      ...
                      Container(
                        ...
                        child: Padding(padding: EdgeInsets.only(bottom: MediaQuery.of(context).viewInsets.bottom),
                            child:TextButton(onPressed: (){
                              ServiceModel service=ServiceModel(userId!,serviceNameController.text,dropdownValue.tr,model.status, serviceDescriptionController.text,servicePriceController.text,
                                  startTimeController.text, endTimeController.text, startDayController.text, endDayController.text,
                                  model.country,model.state,model.city,pinCodeController.text,lat.toString(),long.toString(),emailController.text,
                                  upiController.text,watsAppController.text
                                  ,telegramController.text,zoomLinkController.text,webLinkController.text,model.totalOrders,model.averageRating,customFileds);
                              update(service,model.serviceId);
                            },
                                style: ButtonStyle(backgroundColor: MaterialStateProperty.all(Constants.appButtonColor),
                                    shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                                        RoundedRectangleBorder(
